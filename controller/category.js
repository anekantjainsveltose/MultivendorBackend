...
exports.addcategory = async (req, res) => {
    const { category_name, parent, type, thumbnail_img, feature, desc, image, web_banner, app_banner } = req.body;
...
exports.edit_category = async (req, res) => {
    const { category_name, image,thumbnail_img, status,type,feature} = req.body;
